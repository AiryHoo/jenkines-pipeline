pipeline {
    ...
    post {
		success {
			dingTalk accessToken:'83d77d2f5cfacf44bc2f0601ef05da82b67aa5031e15e68592443cf1e339edbc',imageUrl:'',jenkinsUrl:'http://192.168.248.153:8080/',message:'pipeline success, congratulations~'
		}
		failure {
